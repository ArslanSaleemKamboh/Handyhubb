...
<img src="{{asset('public/backend/img/user/user-13.jpg')}}" alt="" />
...
<form action="{{route('admin/logout')}}" method="post">
    @csrf
      <a class="dropdown-item"  onclick="event.preventDefault(); this.closest('form').submit()" href="javascript:void(0)" >
        logout
      </a>
      </form>
</div>
