    ...
    <div id="header">
        <div class="container">
            ...
            <div class="left-side">
                ...
                <!-- Logo -->
                <div id="logo">
                    <a href="{{ route('home') }}"><img src="{{ asset('public/frontend') }}/images/logo.png"
                            alt=""></a>
                </div>
            ...
            <div class="right-side">
                                ...
                                <div class="header-notifications-scroll" data-simplebar>
                                    <ul>
                                        ...
                                        <li class="notifications-not-read">
                                            <a href="dashboard-messages.html">
                                                <span class="notification-avatar status-online"><img
                                                        src="{{ asset('public/frontend/images/user-avatar-small-03.jpg') }}"
                                                        alt=""></span>
                                        ...
                                        <li class="notifications-not-read">
                                            <a href="dashboard-messages.html">
                                                <span class="notification-avatar status-offline"><img
                                                        src="{{ asset('public/frontend') }}/images/user-avatar-small-02.jpg"
                                                        alt=""></span>
                                                <div class="notification-text">
                                        ...
                                        <li class="notifications-not-read">
                                            <a href="dashboard-messages.html">
                                                <span class="notification-avatar status-online"><img
                                                        src="{{ asset('public/frontend') }}/images/user-avatar-placeholder.png"
                                                        alt=""></span>
                                                <div class="notification-text">
                ...
                <div class="header-widget">
                    ...
                    <div class="header-notifications user-menu">
                        <div class="header-notifications-trigger">
                            <a href="#">
                                <div class="user-avatar status-online"><img height='100%'
                                        src="{{ isset(Auth::user()->profile->profile_img) ? asset('public/storage') . '/' . Auth::user()->profile->profile_img : asset('public/frontend/images/user-avatar-small-01.jpg') }}"
                                        alt=""></div>
                            </a>
                        </div>
        ...
        <div class="status-switch" id="snackbar-user-status">
         ...
         <span class="status-indicator" aria-hidden="true"></span>
                            ...
                            <ul class="user-menu-small-nav">
                                <li><a href="{{ route('home') }}"><i class="icon-material-outline-dashboard"></i>
                                        Dashboard</a></li>
                                <li><a href="{{ route('user.profile') }}"><i class="icon-material-outline-settings"></i>
                                        Settings</a></li>
                                <li>
