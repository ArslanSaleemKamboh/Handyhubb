							...
							<div class="header-notifications-content">
								<div class="header-notifications-scroll" data-simplebar>
									<ul>
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-offline"><img src="{{ asset('public/frontend');}}/images/user-avatar-small-02.jpg" alt=""></span>
												<div class="notification-text">
										...
										<li class="notifications-not-read">
											<a href="dashboard-messages.html">
												<span class="notification-avatar status-online"><img src="{{ asset('public/frontend');}}/images/user-avatar-placeholder.png" alt=""></span>
												<div class="notification-text">
